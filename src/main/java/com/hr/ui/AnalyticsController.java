...
public class AnalyticsController {
    ...
    @FXML
    private CheckBox chkHeadcount;
    @FXML
    private CheckBox chkAttrition;
    @FXML
    ...
    public void generateHRAnalyticsReport(List<String> metrics, String dateRange, String scope)
        ...
        try {
            ...
            // Delegate to SD Controller (UC-15) — full 3-tier workflow with Factory +
            // Strategy + NFR
    ...
    private void handleGenerate() {
        ...
        if (chkHeadcount.isSelected())
            metrics.add("headcount");
        if (chkAttrition.isSelected())
            metrics.add("attrition");
        if (chkLeave.isSelected())
            metrics.add("leave");
        if (chkAttendance.isSelected())
            metrics.add("attendance");
